...
class EvalConfig(BaseConfig):
    ...
    EVAL_RESULTS_DIR: where a run writes its result file, outside the package like the
        fetched corpus, since a run's output is data rather than something to version.
    """
